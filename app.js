document.addEventListener('DOMContentLoaded', function () {
    ...
    const openVideoPlayer = (videoData) => {
        ...
        document.getElementById('likeCount').textContent = videoData.likes || 0;
        document.getElementById('dislikeCount').textContent = videoData.dislikes || 0;
        ...
        document.getElementById('dislikeButton').onclick = () => {
            videoData.dislikes = (videoData.dislikes || 0) + 1;
            localStorage.setItem('videos', JSON.stringify(videos));
